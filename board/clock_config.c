...
- {id: FLEXCAN0_clock.outFreq, value: 80 MHz}
- {id: FLEXCAN1_clock.outFreq, value: 80 MHz}
- {id: FRO_12M_clock.outFreq, value: 12 MHz}
- {id: FRO_HF_clock.outFreq, value: 48 MHz}
- {id: MAIN_clock.outFreq, value: 150 MHz}
- {id: PLL0_CLK_clock.outFreq, value: 150 MHz}
- {id: PLL1_CLK_clock.outFreq, value: 80 MHz}
- {id: Slow_clock.outFreq, value: 37.5 MHz}
- {id: System_clock.outFreq, value: 150 MHz}
- {id: gdet_clock.outFreq, value: 48 MHz}
- {id: pll1_clk0_clock.outFreq, value: 80 MHz}
- {id: trng_clock.outFreq, value: 48 MHz}
settings:
...
- {id: SYSCON.FLEXCAN0CLKSEL.sel, value: SYSCON.pll1_clk0}
- {id: SYSCON.FLEXCAN1CLKSEL.sel, value: SYSCON.pll1_clk0}
- {id: SYSCON.FLEXSPICLKSEL.sel, value: NO_CLOCK}
- {id: SYSCON.FREQMEREFCLKSEL.sel, value: SYSCON.evtg_out0a}
- {id: SYSCON.FREQMETARGETCLKSEL.sel, value: SYSCON.evtg_out0a}
sources:
...
void BOARD_BootClockPLL150M(void)
{
    ...
    const pll_setup_t pll1Setup = {
        .pllctrl = SCG_SPLLCTRL_SOURCE(0U) | SCG_SPLLCTRL_SELI(43U) | SCG_SPLLCTRL_SELP(21U),
        .pllndiv = SCG_SPLLNDIV_NDIV(4U),
        .pllpdiv = SCG_SPLLPDIV_PDIV(3U),
        .pllmdiv = SCG_SPLLMDIV_MDIV(80U),
        .pllRate = 80000000U
    };
    ...
    CLOCK_AttachClk(kPLL1_CLK0_to_FLEXCAN0);                 /*!< Switch FLEXCAN0 to PLL1_CLK0 */
    CLOCK_AttachClk(kPLL1_CLK0_to_FLEXCAN1);                 /*!< Switch FLEXCAN1 to PLL1_CLK0 */

    /*!< Set up dividers */
    CLOCK_SetClkDiv(kCLOCK_DivAhbClk, 1U);           /*!< Set AHBCLKDIV divider to value 1 */
    CLOCK_SetClkDiv(kCLOCK_DivFlexcan0Clk, 1U);           /*!< Set FLEXCAN0CLKDIV divider to value 1 */
    CLOCK_SetClkDiv(kCLOCK_DivFlexcan1Clk, 1U);           /*!< Set FLEXCAN1CLKDIV divider to value 1 */
